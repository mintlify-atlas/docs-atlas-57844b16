---
title: "Get Started with Fireshare in Under 5 Minutes"
sidebarTitle: "Quickstart"
description: "Deploy Fireshare with Docker Compose, mount your video directory, set credentials, and start sharing clips in under 5 minutes."
---
...
<Steps>
  ...
  <Step title="Open Fireshare in your browser">
    ...
    Sign in with the `ADMIN_USERNAME` and `ADMIN_PASSWORD` you set in the Compose file.
