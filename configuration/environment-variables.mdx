---
title: "Environment Variable Reference for Fireshare Docker"
...
<Note>
  Fireshare also supports LDAP authentication via a separate set of environment variables. See [LDAP](/configuration/ldap) for the full variable list and setup instructions.
</Note>
