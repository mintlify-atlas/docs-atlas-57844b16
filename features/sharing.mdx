---
title: "Share Videos and Images with Unique Links"
...
Pass the special sentinel string `__autogenerate__` as the password value. Fireshare generates a cryptographically random 12-character URL-safe token, stores the hash, and returns the plain-text value in the response body so you can share it:
...
{"generated_password": "aB3xQr9pLkWz"}
```
