---
title: "Running Fireshare in Demo Mode"
sidebarTitle: "Demo Mode"
description: "Demo mode creates a restricted demo account alongside the admin account, useful for public showcases. Configure upload limits and automatic data reset on restart."
---
